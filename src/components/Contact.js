...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    return(
      ...
      <form className='contact-me p-0 pt-4' ref={form} onSubmit={sendEmail}>
      ...
      <textarea className='m-0 contact-text' name="message" required placeholder='Your Message' /><br></br>
...
//Second attempt adding the contact Page.